...
<head>
    ...
    href="../Confirm Iphone 13 mini/logo-maison-removebg-preview.png" 
    type="image/x-icon">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirm Iphone 13 mini</title>
    <link rel="stylesheet" href="../Confirm Iphone 13 mini/Confirm Iphone 13 mini.css">
...
<img src="../Confirm Iphone 13 mini/logo-maison-removebg-preview.png"  width="250px" height="250px" alt="">
    <!-- <div class="p">  <h1>Top 10 helps you choose your mobile phone in the easiest way, register and discover.</h1>
        ...
        <?php } ?>
            ...
            <img class="img2" src="../Confirm Iphone 13 mini/download-removebg-preview-removebg-preview.png"  alt="">

            <h1>  Iphone 13 mini </h1>
            <Ul class="p1">
                <li>       مساحه داخليه 128 جيجا بايت 
                </li>
