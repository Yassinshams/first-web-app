...
<head>
    ...
    href="../Confirm Asus Zenfone 8/logo-maison-removebg-preview.png" 
    type="image/x-icon">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirm Asus Zenfone 8</title>
    <link rel="stylesheet" href="../Confirm Asus Zenfone 8/Confirm Asus Zenfone 8.css">
...
<img src="../Confirm Asus Zenfone 8/logo-maison-removebg-preview.png"  width="250px" height="250px" alt="">
    <!-- <div class="p">  <h1>Top 10 helps you choose your mobile phone in the easiest way, register and discover.</h1>
        ...
        <?php } ?>
            ...
            <img class="img2" src="../Confirm Asus Zenfone 8/Asus-Zenfone-2-removebg-preview (2).png "  alt="">

            <h1> Asus Zenfone 8</h1>
