...
<head>
    ...
    href="../Confirm Google Pixel 7 Pro/logo-maison-removebg-preview.png" 
    type="image/x-icon">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirm Google Pixel 7 Pro</title>
    <link rel="stylesheet" href="../Confirm Google Pixel 7 Pro/Confirm Google Pixel 7 Pro.css">
...
<img src="../Confirm Google Pixel 7 Pro/logo-maison-removebg-preview.png"  width="250px" height="250px" alt="">
    <!-- <div class="p">  <h1>Top 10 helps you choose your mobile phone in the easiest way, register and discover.</h1>
        ...
        <?php } ?>
            ...
            <img class="img2" src="../Confirm Google Pixel 7 Pro/google-pixel-7-pro-review-images_quv6-removebg-preview (1).png"  alt="">
