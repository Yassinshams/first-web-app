...
<head>
    ...
    href="../Confirm oppo find x6 pro/logo-maison-removebg-preview.png" 
    type="image/x-icon">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirm oppo find x6 pro</title>
    <link rel="stylesheet" href="../Confirm oppo find x6 pro/Confirm oppo find x6 pro.css">
...
<img src="../Confirm oppo find x6 pro/logo-maison-removebg-preview.png"  width="250px" height="250px" alt="">
    <!-- <div class="p">  <h1>Top 10 helps you choose your mobile phone in the easiest way, register and discover.</h1>
        ...
        <?php } ?>
            ...
            <img class="img2" src="../Confirm oppo find x6 pro/oppo_find_x6_pro2-removebg-preview.png"  alt="">

            <h1>oppo find x6 pro </h1>
            <Ul class="p1">
